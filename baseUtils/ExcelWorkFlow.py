...
from baseUtils import ExcelUtils
from baseUtils import SysCmd
from baseUtils import SysInfo
import types
                    ...
                    if _currentLoopRow >= targetSheet_.maxRow or \
                        ...
                        if _nextLoopRow < targetSheet_.maxRow:
                            ...
                            if _loopRowKey == "" and _loopRowValue != "":
                                ...
                                _parameterObject["val"].append(
                                    checkStrForList(targetSheet_.getStrByCr(3, _nextLoopRow)))
                                while (True):
